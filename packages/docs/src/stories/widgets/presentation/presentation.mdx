...
| `--qc-play-button-background-color`      | `#000`                       | The background color of the play button.                                                                                                        |
...
| `--qc-close-button-background-color`     | `#000`                       | The background color of the close button.                                                                                                       |
