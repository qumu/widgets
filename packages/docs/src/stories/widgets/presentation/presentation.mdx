...
```css
:root {
  --qc-pw-theme-background-color: #09091a;
  --qc-pw-theme-color: #f5f8fa;
}
```
| Variable                                    | Default                                                          | Description                                                                                                                                     |
|---------------------------------------------|------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| `--qc-pw-presentation-widget-border-radius`    | `0`                                                              | The border radius of the widget container.                                                                                                      |
| `--qc-pw-presentation-widget-height`           | `100%`                                                           | The height of the widget container.                                                                                                             |
| `--qc-pw-presentation-widget-width`            | `100%`                                                           | The width of the widget container.                                                                                                              |
| `--qc-pw-thumbnail-image-fit`                  | `cover`                                                          | How the thumbnail image fits its container. See [object-fit](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/object-fit). |
| `--qc-pw-play-button-background-color`         | `rgb(0 0 0 / .8)`                                                | The background color of the play button.                                                                                                        |
| `--qc-pw-play-button-color`                    | `#fff`                                                           | The color of the play button.                                                                                                                   |
| `--qc-pw-play-button-margin`                   | `16px`                                                           | The margin around the thumbnail’s play button.                                                                                                  |
| `--qc-pw-play-button-padding`                  | `8px`                                                            | The padding between the play icon and the button background.                                                                                    |
| `--qc-pw-play-button-hover-background-color`   | `rgb(0 0 0 / .9)`                                                | The background color of the play button on hover.                                                                                               |
| `--qc-pw-play-button-hover-color`              | `#fff`                                                           | The color of the play button on hover.                                                                                                          |
| `--qc-pw-play-button-active-background-color`  | `#000`                                                           | The background color of the play button when active.                                                                                            |
| `--qc-pw-play-button-active-color`             | `#fff`                                                           | The color of the play button when active.                                                                                                       |
| `--qc-pw-dialog-backdrop-color`                | `rgb(0 0 0 / .5)`                                                | The color of the modal backdrop overlay.                                                                                                        |
| `--qc-pw-dialog-background-color`              | `#000`                                                           | The background color of the modal container.                                                                                                    |
| `--qc-pw-dialog-border`                        | `3px solid #000`                                                 | The border of the modal.                                                                                                                        |
| `--qc-pw-dialog-border-radius`                 | `0`                                                              | The border radius of the modal container.                                                                                                       |
| `--qc-pw-dialog-padding`                       | `0`                                                              | The padding inside the modal container between the border and the content.                                                                      |
| `--qc-pw-dialog-max-width`                     | `1100px`                                                         | The maximum width of the modal.                                                                                                                 |
| `--qc-pw-dialog-width`                         | `90vw`                                                           | The default width of the modal.                                                                                                                 |
| `--qc-pw-close-button-background-color`        | `rgb(0 0 0 / .75)`                                               | The background color of the close button.                                                                                                       |
| `--qc-pw-close-button-color`                   | `#fff`                                                           | The color of the close button icon.                                                                                                             |
| `--qc-pw-close-button-icon-size`               | `20px`                                                           | The size of the close button icon.                                                                                                              |
| `--qc-pw-close-button-padding`                 | `6px`                                                            | The padding between the close icon and the button background.                                                                                   |
| `--qc-pw-close-button-shadow`                  | `0 0 1px 1px #000`                                               | The box shadow of the close button.                                                                                                             |
| `--qc-pw-close-button-hover-background-color`  | `rgb(0 0 0 / .9)`                                                | The background color of the close button on hover.                                                                                              |
| `--qc-pw-close-button-hover-color`             | `#fff`                                                           | The color of the close button icon on hover.                                                                                                    |
| `--qc-pw-close-button-active-background-color` | `#000`                                                           | The background color of the close button when active.                                                                                           |
| `--qc-pw-close-button-active-color`            | `#fff`                                                           | The color of the close button icon when active.                                                                                                 |
| `--qc-pw-not-found-background-color`           | `transparent`                                                    | The background color of the “Not Found” message container.                                                                                      |
| `--qc-pw-not-found-border`                     | `1px solid light-dark(rgb(0 0 0 / .15), rgb(255 255 255 / .15))` | The border of the “Not Found” message container.                                                                                                |
| `--qc-pw-not-found-color`                      | `light-dark(#000, #fff)`                                         | The text color of the “Not Found” message.                                                                                                      |
| `--qc-pw-not-found-icon-color`                 | `light-dark(rgb(0 0 0 / .25), rgb(255 255 255 / .25))`           | The color of the “Not Found” icon.                                                                                                              |
