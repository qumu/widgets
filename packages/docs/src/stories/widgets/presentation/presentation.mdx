...
|-------------------------------------------------------|------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| `--qc-theme-background-color`                         | `#09091a`                          | The background color of the widget.                                                                                                             |
| `--qc-theme-color`                                    | `#f5f8fa`                          | The default text and icon color inside the widget.                                                                                              |
...
| `--qc-thumbnail-play-button-margin`                   | `16px`                             | The margin around the thumbnail’s play button.                                                                                                  |
| `--qc-thumbnail-play-button-padding`                  | `8px`                              | The padding between the play icon and the button background.                                                                                    |
| `--qc-thumbnail-play-button-background-color`         | `var(--qc-theme-background-color)` | The background color of the play button.                                                                                                        |
| `--qc-thumbnail-play-button-background-opacity`       | `0.8`                              | The opacity of the play button when not hovered.                                                                                                |
| `--qc-thumbnail-play-button-background-opacity-hover` | `1`                                | The opacity of the play button when hovered.                                                                                                    |
| `--qc-dialog-backdrop`                                | `rgb(0 0 0 / 0.5)`                 | The color of the modal backdrop overlay.                                                                                                        |
| `--qc-dialog-background-color`                        | `#000`                             | The background color of the modal container.                                                                                                    |
| `--qc-dialog-border-color`                            | `#000`                             | The color of the modal border.                                                                                                                  |
| `--qc-dialog-border-radius`                           | `0`                                | The border radius of the modal container.                                                                                                       |
| `--qc-dialog-border-style`                            | `solid`                            | The border style of the modal container.                                                                                                        |
| `--qc-dialog-border-width`                            | `3px`                              | The width of the modal border.                                                                                                                  |
| `--qc-dialog-close-button-background-color`           | `var(--qc-theme-background-color)` | The background color of the close button.                                                                                                       |
| `--qc-dialog-close-button-background-opacity`         | `0.8`                              | The opacity of the close button when not hovered.                                                                                               |
| `--qc-dialog-close-button-background-opacity-hover`   | `1`                                | The opacity of the close button when hovered.                                                                                                   |
| `--qc-dialog-close-button-color`                      | `var(--qc-theme-color)`            | The color of the close button icon.                                                                                                             |
| `--qc-dialog-close-button-padding`                    | `6px`                              | The padding between the close icon and the button background.                                                                                   |
| `--qc-dialog-close-button-shadow`                     | `0 0 1px 1px #000000`              | The box shadow of the close button.                                                                                                             |
| `--qc-dialog-close-icon-size`                         | `20px`                             | The size of the close button icon.                                                                                                              |
| `--qc-dialog-padding`                                 | `0`                                | The padding inside the modal container between the border and the content.                                                                      |
| `--qc-dialog-width-max`                               | `1100px`                           | The maximum width of the modal.                                                                                                                 |
| `--qc-dialog-width`                                   | `90vw`                             | The default width of the modal.                                                                                                                 |
| `--qc-not-found-border-width`                         | `1px`                              | The border width of the “Not Found” message container.                                                                                          |
| `--qc-not-found-border-style`                         | `solid`                            | The border style of the “Not Found” message container.                                                                                          |
| `--qc-not-found-border-color`                         | `#cbd5dc`                          | The border color of the “Not Found” message container.                                                                                          |
| `--qc-not-found-color`                                | `#09091a`                          | The text color of the “Not Found” message.                                                                                                      |
| `--qc-not-found-icon-color`                           | `#cbd5dc`                          | The color of the “Not Found” icon.                                                                                                              |
