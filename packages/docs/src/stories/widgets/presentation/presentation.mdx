...
| `--qc-not-found-border`                     | `1px solid rgb(0 0 0 / .15)` | The border of the “Not Found” message container.                                                                                                |
| `--qc-not-found-color`                      | `#000`                       | The text color of the “Not Found” message.                                                                                                      |
| `--qc-not-found-icon-color`                 | `rgb(0 0 0 / .25)`           | The color of the “Not Found” icon.                                                                                                              |
