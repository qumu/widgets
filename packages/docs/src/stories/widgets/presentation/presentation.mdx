...
| `--qc-play-button-background-color`      | `#09091a`             | The background color of the play button.                                                                                                        |
| `--qc-play-button-color`                 | `#f5f8fa`             | The color of the play button.                                                                                                                   |
| `--qc-play-button-opacity`               | `0.8`                 | The opacity of the play button when not hovered.                                                                                                |
| `--qc-play-button-hover-opacity`         | `1`                   | The opacity of the play button when hovered.                                                                                                    |
...
| `--qc-dialog-backdrop-color`             | `rgb(0 0 0 / 0.5)`    | The color of the modal backdrop overlay.                                                                                                        |
...
| `--qc-close-button-background-color`     | `#09091a`             | The background color of the close button.                                                                                                       |
| `--qc-close-button-color`                | `#f5f8fa`             | The color of the close button icon.                                                                                                             |
| `--qc-close-button-opacity`              | `0.8`                 | The opacity of the close button when not hovered.                                                                                               |
| `--qc-close-button-hover-opacity`        | `1`                   | The opacity of the close button when hovered.                                                                                                   |
...
| `--qc-close-button-shadow`               | `0 0 1px 1px #000000` | The box shadow of the close button.                                                                                                             |
| `--qc-not-found-background-color`        | `transparent`         | The background color of the “Not Found” message container.                                                                                      |
| `--qc-not-found-border`                  | `1px solid #cbd5dc`   | The border of the “Not Found” message container.                                                                                                |
